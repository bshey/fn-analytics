    ...
    <div className="grid gap-4 xl:grid-cols-2">
      ...
      >
        ...
        <Caption>
          ...
          Quarantine processing time isn't shown — most pass/fail scans never reach the warehouse (see ⓘ).
          Channel / material / mfg-type
