    ...
    <div className="grid gap-4 xl:grid-cols-2">
      ...
      >
        ...
        <Caption>
          ...
          Quarantine → processed counts un-scanned lots until their order shipped, or until now while it's open.
